""" @bruin
name: bronze/ingest.ingest_olist_kaggle
type: python
description: "Retrieve Olist dataset from Kaggle and store it in a specified local directory (Bronze Layer)."
@bruin """
...
def run():
    ...
    target_dir = os.getenv(
        "RAW_DATA_PATH",
        "/workspaces/olist-data-pipeline/data"
    )
